...
public class AndroidMeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState == null) {
            ...
            Bundle bundle = getIntent().getBundleExtra(Intent.ACTION_ATTACH_DATA);
            ...
            headFragment.setListIndex(bundle.getInt(MainActivity.HEAD_INDEX));
            ...
            bodyFragment.setListIndex(bundle.getInt(MainActivity.BODY_INDEX));
            fragmentManager.beginTransaction()
            ...
            legFragment.setListIndex(bundle.getInt(MainActivity.LEGS_INDEX));
            fragmentManager.beginTransaction()
