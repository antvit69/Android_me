...
public class AndroidImageAssets {
    ...
    private static final List<Integer> heads = buildListInteger(R.drawable.head1,
            R.drawable.head2,
            R.drawable.head3,
            R.drawable.head4,
            R.drawable.head5,
    ...
    private static final List<Integer> bodies = buildListInteger(R.drawable.body1,
            R.drawable.body2,
            R.drawable.body3,
            R.drawable.body4,
            R.drawable.body5,
    ...
    private static final List<Integer> legs = buildListInteger(R.drawable.legs1,
            R.drawable.legs2,
            R.drawable.legs3,
            R.drawable.legs4,
            R.drawable.legs5,
    ...
    public static List<Integer> buildListInteger(Integer... args) {
