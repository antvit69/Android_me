...
public class AndroidImageAssets {
    ...
    private static final List<Integer> heads = Arrays.asList(
            R.drawable.head1,
            R.drawable.head2,
            R.drawable.head3,
            R.drawable.head4,
...
//    }};
    ...
    private static final List<Integer> bodies = Arrays.asList(
        R.drawable.body1,
        R.drawable.body2,
        R.drawable.body3,
        R.drawable.body4,
...
//    }};
    ...
    private static final List<Integer> legs = Arrays.asList(
            R.drawable.legs1,
            R.drawable.legs2,
            R.drawable.legs3,
            R.drawable.legs4,
...
//    }};
    ...
    public static int getBodyPartCount() {
        return heads.size();
    }
}